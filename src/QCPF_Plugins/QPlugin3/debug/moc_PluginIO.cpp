...
QT_MOC_LITERAL(9, 87, 13), // "OnViewCreated"
QT_MOC_LITERAL(10, 101, 12), // "OnViewLoaded"
QT_MOC_LITERAL(11, 114, 13), // "OnViewClosing"
QT_MOC_LITERAL(12, 128, 13) // "handleTimeout"

    },
    "PluginIO\0slot_Plugin\0\0arg_in\0QVariant&\0"
    "arg_out\0slot_Action\0checkState\0"
    "OnCoreInitialize\0OnViewCreated\0"
    "OnViewLoaded\0OnViewClosing\0handleTimeout"
};
...
void PluginIO::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { int _r = _t->OnCoreInitialize();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 3: { int _r = _t->OnViewCreated();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 4: { int _r = _t->OnViewLoaded();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 5: { int _r = _t->OnViewClosing();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
