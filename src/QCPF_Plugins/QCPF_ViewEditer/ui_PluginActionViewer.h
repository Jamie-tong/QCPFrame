...
public:
    ...
    void setupUi(QDialog *PluginActionViewer)
    {
        ...
        PluginActionViewer->resize(362, 440);
        QIcon icon;
        ...
        buttonBox->setGeometry(QRect(10, 390, 341, 41));
        ...
        groupBox_2->setGeometry(QRect(10, 190, 341, 191));
        ...
        txtActionName->setGeometry(QRect(80, 20, 251, 20));
        ...
        txtActionDetail->setGeometry(QRect(80, 50, 251, 131));
        label_8 = new QLabel(groupBox_2);
        label_8->setObjectName(QString::fromUtf8("label_8"));
        label_8->setGeometry(QRect(16, 50, 61, 20));
        ...
        cbPluginAction->setGeometry(QRect(80, 70, 251, 22));
