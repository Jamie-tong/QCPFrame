/********************************************************************************
** Form generated from reading UI file 'ViewEditer.ui'
**
...
#ifndef UI_VIEWEDITER_H
#define UI_VIEWEDITER_H
...
public:
    ...
    void setupUi(QDialog *ViewEditer)
    {
        if (ViewEditer->objectName().isEmpty())
            ViewEditer->setObjectName(QString::fromUtf8("ViewEditer"));
        ViewEditer->resize(1207, 780);
        QIcon icon;
        icon.addFile(QString::fromUtf8("../../bin/debug/Images/viewedit.png"), QSize(), QIcon::Normal, QIcon::Off);
        ViewEditer->setWindowIcon(icon);
        ViewEditer->setAutoFillBackground(true);
        btnOk = new QPushButton(ViewEditer);
        btnOk->setObjectName(QString::fromUtf8("btnOk"));
        btnOk->setGeometry(QRect(843, 730, 100, 35));
        btnOk->setMinimumSize(QSize(0, 35));
        btnCancel = new QPushButton(ViewEditer);
        btnCancel->setObjectName(QString::fromUtf8("btnCancel"));
        btnCancel->setGeometry(QRect(1100, 730, 100, 35));
        btnCancel->setMinimumSize(QSize(0, 35));
        btnApply = new QPushButton(ViewEditer);
        ...
        tabWidget = new QTabWidget(ViewEditer);
...
"border-color: rgb(159, 159, 159);"));
        ...
        groupBox = new QGroupBox(ViewEditer);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        groupBox->setGeometry(QRect(-10, 720, 1500, 2));
        groupBox->setFlat(true);

        retranslateUi(ViewEditer);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(ViewEditer);
    } // setupUi

    void retranslateUi(QDialog *ViewEditer)
    {
        ViewEditer->setWindowTitle(QCoreApplication::translate("ViewEditer", "View Editer", nullptr));
        btnOk->setText(QCoreApplication::translate("ViewEditer", "Ok(&O)", nullptr));
        btnCancel->setText(QCoreApplication::translate("ViewEditer", "Cancel(&C)", nullptr));
        btnApply->setText(QCoreApplication::translate("ViewEditer", "Apply(&A)", nullptr));
        btnAddNode->setText(QCoreApplication::translate("ViewEditer", "Add Node", nullptr));
        label_2->setText(QCoreApplication::translate("ViewEditer", "Node Name:", nullptr));
        label_8->setText(QCoreApplication::translate("ViewEditer", "shortcut key:", nullptr));
        btnDeleteNode->setText(QCoreApplication::translate("ViewEditer", "Delete Node", nullptr));
        btnAddSeperator->setText(QCoreApplication::translate("ViewEditer", "Add Separator", nullptr));
        chkMenuCheckable->setText(QCoreApplication::translate("ViewEditer", "Checkable", nullptr));
        cbMenuAuthority->setItemText(0, QCoreApplication::translate("ViewEditer", "Developor", nullptr));
        cbMenuAuthority->setItemText(1, QCoreApplication::translate("ViewEditer", "Manager", nullptr));
        cbMenuAuthority->setItemText(2, QCoreApplication::translate("ViewEditer", "User", nullptr));
        cbMenuAuthority->setItemText(3, QCoreApplication::translate("ViewEditer", "Guest", nullptr));

        label->setText(QCoreApplication::translate("ViewEditer", "Authority:", nullptr));
        groupBox_2->setTitle(QString());
        btnUp->setText(QCoreApplication::translate("ViewEditer", "Up", nullptr));
        btnLeft->setText(QCoreApplication::translate("ViewEditer", "Left", nullptr));
        btnDown->setText(QCoreApplication::translate("ViewEditer", "Down", nullptr));
        btnRight->setText(QCoreApplication::translate("ViewEditer", "Right", nullptr));
        btnIconFinder->setText(QCoreApplication::translate("ViewEditer", "Load Icon", nullptr));
        btnAddAction->setText(QCoreApplication::translate("ViewEditer", "Map Function", nullptr));
        btnClearAction->setText(QCoreApplication::translate("ViewEditer", "Clear Function", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = treeMenuEdit->headerItem();
        ___qtreewidgetitem->setText(5, QCoreApplication::translate("ViewEditer", "\345\244\207\346\263\250", nullptr));
        ___qtreewidgetitem->setText(4, QCoreApplication::translate("ViewEditer", "Action", nullptr));
        ___qtreewidgetitem->setText(3, QCoreApplication::translate("ViewEditer", "\347\273\204\344\273\266ID", nullptr));
        ___qtreewidgetitem->setText(2, QCoreApplication::translate("ViewEditer", "\345\233\276\346\240\207\350\267\257\345\276\204", nullptr));
        ___qtreewidgetitem->setText(1, QCoreApplication::translate("ViewEditer", "\345\277\253\346\215\267\351\224\256", nullptr));
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("ViewEditer", "\350\217\234\345\215\225\346\240\217", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("ViewEditer", "MenuBar", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("ViewEditer", "ToolBar", nullptr));
        label_3->setText(QCoreApplication::translate("ViewEditer", "Action From Menu:", nullptr));
        btnAddAction_Toolbar->setText(QCoreApplication::translate("ViewEditer", "Add Action", nullptr));
        btnAddSeperator_Toolbar->setText(QCoreApplication::translate("ViewEditer", "Add Seperator", nullptr));
        btnDeleteItem_Toolbar->setText(QCoreApplication::translate("ViewEditer", "Delete Item", nullptr));
        btnAddWidget_Toolbar->setText(QCoreApplication::translate("ViewEditer", "Add Widget", nullptr));
        label_4->setText(QCoreApplication::translate("ViewEditer", "Toolbar height:", nullptr));
        label_5->setText(QCoreApplication::translate("ViewEditer", "Item Width:", nullptr));
        label_6->setText(QCoreApplication::translate("ViewEditer", "Item Height:", nullptr));
        btnMoveDown_Toolbar->setText(QCoreApplication::translate("ViewEditer", "Down", nullptr));
        btnMoveUp_Toolbar->setText(QCoreApplication::translate("ViewEditer", "Up", nullptr));
        btnAddToolbar->setText(QCoreApplication::translate("ViewEditer", "Add Bar", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("ViewEditer", "StatusBar", nullptr));
        btnDeleteItem_Statusbar->setText(QCoreApplication::translate("ViewEditer", "Delete Item", nullptr));
        btnAddWidget_Statusbar->setText(QCoreApplication::translate("ViewEditer", "Add Widget", nullptr));
        label_9->setText(QCoreApplication::translate("ViewEditer", "Statusbar height:", nullptr));
        label_10->setText(QCoreApplication::translate("ViewEditer", "Item Width:", nullptr));
        label_11->setText(QCoreApplication::translate("ViewEditer", "Item Height:", nullptr));
        btnMoveDown_Statusbar->setText(QCoreApplication::translate("ViewEditer", "Down", nullptr));
        btnMoveUp_Statusbar->setText(QCoreApplication::translate("ViewEditer", "Up", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QCoreApplication::translate("ViewEditer", "ToolBar && StatusBar", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QCoreApplication::translate("ViewEditer", "Workspace", nullptr));
        chb_IsShowStatusBar->setText(QCoreApplication::translate("ViewEditer", "Show status-bar", nullptr));
        chb_IsShowMenu->setText(QCoreApplication::translate("ViewEditer", "Show menu-bar", nullptr));
        chb_IsShowToolBar->setText(QCoreApplication::translate("ViewEditer", "Show tool-bar", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("ViewEditer", "Utility", nullptr));
...
namespace Ui {
    class ViewEditer: public Ui_ViewEditer {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_VIEWEDITER_H
