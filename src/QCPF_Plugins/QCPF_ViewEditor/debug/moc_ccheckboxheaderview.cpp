...
#error "The header file 'ccheckboxheaderview.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CCheckBoxHeaderView_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject CCheckBoxHeaderView::staticMetaObject = { {
    &QHeaderView::staticMetaObject,
    qt_meta_stringdata_CCheckBoxHeaderView.data,
    qt_meta_data_CCheckBoxHeaderView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CCheckBoxHeaderView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CCheckBoxHeaderView.stringdata0))
