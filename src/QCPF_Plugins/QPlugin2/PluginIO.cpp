...
{
    instance = this;
    PluginIO::I_PluginID = QStringLiteral("QPlugin2");
    PluginIO::I_PluginType = PT_NON_SYS;
    PluginIO::I_PluginAliasName = QStringLiteral("QPlugin2");
    PluginIO::I_PluginAuther = QStringLiteral("Jamie.T");
    PluginIO::I_PluginVersion = QStringLiteral("1.0.0.2");
    PluginIO::I_PluginComment = QStringLiteral("QPlugin2 comment");
    PluginIO::I_PluginTag = QStringLiteral("NON-SINGLETON\\NON_SYSTEM\\DataUpLoad");
