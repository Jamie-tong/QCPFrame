...
QT_MOC_LITERAL(1, 9, 10), // "sig_Plugin"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 6), // "arg_in"
QT_MOC_LITERAL(4, 28, 9), // "QVariant&"
QT_MOC_LITERAL(5, 38, 7), // "arg_out"
QT_MOC_LITERAL(6, 46, 14), // "sig_OutputInfo"
QT_MOC_LITERAL(7, 61, 14), // "tagOutputInfo&"
QT_MOC_LITERAL(8, 76, 4), // "info"
QT_MOC_LITERAL(9, 81, 11), // "slot_Plugin"
QT_MOC_LITERAL(10, 93, 11), // "slot_Action"
QT_MOC_LITERAL(11, 105, 10), // "checkState"
QT_MOC_LITERAL(12, 116, 16), // "OnCoreInitialize"
QT_MOC_LITERAL(13, 133, 21), // "OnViewModelInitialize"
QT_MOC_LITERAL(14, 155, 13), // "OnViewCreated"
QT_MOC_LITERAL(15, 169, 12), // "OnViewLoaded"
QT_MOC_LITERAL(16, 182, 13) // "OnViewClosing"

    },
    "PluginIO\0sig_Plugin\0\0arg_in\0QVariant&\0"
    "arg_out\0sig_OutputInfo\0tagOutputInfo&\0"
    "info\0slot_Plugin\0slot_Action\0checkState\0"
...
void PluginIO::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = int (PluginIO::*)(QVariant , QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PluginIO::sig_Plugin)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = int (PluginIO::*)(tagOutputInfo & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PluginIO::sig_OutputInfo)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
int PluginIO::sig_Plugin(QVariant _t1, QVariant & _t2)
{
    int _t0{};
...
// SIGNAL 1
int PluginIO::sig_OutputInfo(tagOutputInfo & _t1)
{
    int _t0{};
