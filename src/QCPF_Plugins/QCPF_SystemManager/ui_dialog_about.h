...
public:
    ...
    void retranslateUi(QDialog *Dialog_About)
    {
        ...
        label_3->setText(QCoreApplication::translate("Dialog_About", "Version: v1.0.0.2", nullptr));
