...
public:
    ...
    void setupUi(QDialog *Dialog_About)
    {
        ...
        label_2->setGeometry(QRect(393, 220, 141, 31));
        ...
        labCoreVersion->setGeometry(QRect(40, 250, 151, 21));
