...
public:
    ...
    void retranslateUi(QWidget *wdt_CoreVersion)
    {
        ...
        label->setText(QCoreApplication::translate("wdt_CoreVersion", "Core Version:", nullptr));
