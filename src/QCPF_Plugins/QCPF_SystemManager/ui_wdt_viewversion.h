...
public:
    ...
    void retranslateUi(QWidget *wdt_ViewVersion)
    {
        ...
        label->setText(QCoreApplication::translate("wdt_ViewVersion", "View Version:", nullptr));
    } // retranslateUi
