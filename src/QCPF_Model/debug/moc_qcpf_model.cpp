...
QT_MOC_LITERAL(1, 11, 8), // "sig_Core"
...
QT_MOC_LITERAL(18, 212, 9), // "slot_Core"
QT_MOC_LITERAL(19, 222, 15), // "slot_Initialize"
...
QT_MOC_LITERAL(28, 332, 17) // "slot_CancelConfig"
    ...
    "info\0sig_PluginSelOrNSelFinished\0"
    "origPluginID\0isSel\0sig_CloneFinished\0"
...
void QCPF_Model::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->sig_Core((*reinterpret_cast< QVariant(*)>(_a[1])),(*reinterpret_cast< QVariant(*)>(_a[2])));
        ...
        case 5: { int _r = _t->slot_Core((*reinterpret_cast< QVariant(*)>(_a[1])),(*reinterpret_cast< QVariant(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
