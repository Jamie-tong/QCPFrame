...
QT_MOC_LITERAL(6, 67, 14), // "slot_InputInfo"
QT_MOC_LITERAL(7, 82, 19), // "slot_LoadConfigFile"
QT_MOC_LITERAL(8, 102, 16), // "viewConfigModel&"
QT_MOC_LITERAL(9, 119, 6), // "config"
QT_MOC_LITERAL(10, 126, 19), // "slot_SaveConfigFile"
QT_MOC_LITERAL(11, 146, 16), // "slot_ApplyConfig"
QT_MOC_LITERAL(12, 163, 17) // "slot_CancelConfig"

    },
    "QCPF_ViewModel\0sig_OutputInfo\0\0"
    "tagOutputInfo&\0info\0slot_Initialize\0"
    "slot_InputInfo\0slot_LoadConfigFile\0"
...
void QCPF_ViewModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { int _r = _t->slot_InputInfo((*reinterpret_cast< tagOutputInfo(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 3: { int _r = _t->slot_LoadConfigFile((*reinterpret_cast< viewConfigModel(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 4: { int _r = _t->slot_SaveConfigFile();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 5: { int _r = _t->slot_ApplyConfig();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 6: { int _r = _t->slot_CancelConfig();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
